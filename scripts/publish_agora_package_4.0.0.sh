...
#
# Usage:
#   bash scripts/publish_agora_package_4.0.0.sh <target_project_dir> [target_version]
#
# Example:
#   bash scripts/publish_agora_package_4.0.0.sh .worktree/agora
#   bash scripts/publish_agora_package_4.0.0.sh .worktree/agora 1.4.0
#
# Notes:
