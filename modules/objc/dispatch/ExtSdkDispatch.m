...
- (void)callSdkApi:(nonnull NSString *)methodType
    ...
    case ExtSdkMethodKeyInitValue:
        [[ExtSdkClientWrapper getInstance] initSDKWithDict:ps
                                            withMethodType:methodType
                                                    result:callback];
        break;
    case ExtSdkMethodKeyCreateAccountValue:
        [[ExtSdkClientWrapper getInstance] createAccount:ps
                                          withMethodType:methodType
                                                  result:callback];
        break;
    case ExtSdkMethodKeyLoginValue:
        [[ExtSdkClientWrapper getInstance] login:ps
                                  withMethodType:methodType
                                          result:callback];
        break;
    case ExtSdkMethodKeyLogoutValue:
        [[ExtSdkClientWrapper getInstance] logout:ps
                                   withMethodType:methodType
                                           result:callback];
        break;
    case ExtSdkMethodKeyChangeAppKeyValue:
        [[ExtSdkClientWrapper getInstance] changeAppKey:ps
                                         withMethodType:methodType
                                                 result:callback];
        break;
    case ExtSdkMethodKeyChangeAppIdValue:
        [[ExtSdkClientWrapper getInstance] changeAppId:ps
                                        withMethodType:methodType
                                                result:callback];
        break;
    case ExtSdkMethodKeyIsLoggedInBeforeValue:
        [[ExtSdkClientWrapper getInstance] isLoggedInBefore:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    case ExtSdkMethodKeyUploadLogValue:
        [[ExtSdkClientWrapper getInstance] uploadLog:ps
                                      withMethodType:methodType
                                              result:callback];
        break;
    case ExtSdkMethodKeyCompressLogsValue:
        [[ExtSdkClientWrapper getInstance] compressLogs:ps
                                         withMethodType:methodType
                                                 result:callback];
        break;
    case ExtSdkMethodKeyKickDeviceValue:
        [[ExtSdkClientWrapper getInstance] kickDevice:ps
                                       withMethodType:methodType
                                               result:callback];
        break;
    case ExtSdkMethodKeyKickAllDevicesValue:
        [[ExtSdkClientWrapper getInstance] kickAllDevices:ps
                                           withMethodType:methodType
                                                   result:callback];
        break;
    case ExtSdkMethodKeyCurrentUserValue:
        [[ExtSdkClientWrapper getInstance] getCurrentUser:ps
                                           withMethodType:methodType
                                                   result:callback];
        break;
    ...
    case ExtSdkMethodKeyGetTokenValue:
        [[ExtSdkClientWrapper getInstance] getToken:ps
                                     withMethodType:methodType
                                             result:callback];
        break;
    ...
    case ExtSdkMethodKeyIsConnectedValue:
        [[ExtSdkClientWrapper getInstance] isConnected:ps
                                        withMethodType:methodType
                                                result:callback];
        break;
    ...
    case ExtSdkMethodKeyUpdatePushConfigValue:
        [[ExtSdkClientWrapper getInstance] updatePushConfig:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    ...
    case ExtSdkMethodKeySendMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] sendMessage:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    case ExtSdkMethodKeyResendMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] resendMessage:ps
                                               withMethodType:methodType
                                                       result:callback];
        break;
    case ExtSdkMethodKeyAckMessageReadValue:
        [[ExtSdkChatManagerWrapper getInstance] ackMessageRead:ps
                                                withMethodType:methodType
                                                        result:callback];
        break;
    case ExtSdkMethodKeyAckGroupMessageReadValue:
        [[ExtSdkChatManagerWrapper getInstance] ackGroupMessageRead:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeyAckConversationReadValue:
        [[ExtSdkChatManagerWrapper getInstance] ackConversationRead:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeyRecallMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] recallMessage:ps
                                               withMethodType:methodType
                                                       result:callback];
        break;
    case ExtSdkMethodKeyGetConversationValue:
        [[ExtSdkChatManagerWrapper getInstance] getConversationApi:ps
                                                    withMethodType:methodType
                                                            result:callback];
        break;
    case ExtSdkMethodKeyMarkAllChatMsgAsReadValue:
        [[ExtSdkChatManagerWrapper getInstance] markAllMessagesAsRead:ps
                                                       withMethodType:methodType
                                                               result:callback];
        break;
    case ExtSdkMethodKeyGetUnreadMessageCountValue:
        [[ExtSdkChatManagerWrapper getInstance] getUnreadMessageCount:ps
                                                       withMethodType:methodType
                                                               result:callback];
        break;
    case ExtSdkMethodKeyUpdateChatMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] updateChatMessage:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    case ExtSdkMethodKeyDownloadAttachmentInCombineValue:
        [[ExtSdkChatManagerWrapper getInstance]
            downloadAttachmentInCombine:ps
                         withMethodType:methodType
                                 result:callback];
        break;
    case ExtSdkMethodKeyDownloadThumbnailInCombineValue:
        [[ExtSdkChatManagerWrapper getInstance]
            downloadThumbnailInCombine:ps
                        withMethodType:methodType
                                result:callback];
        break;
    case ExtSdkMethodKeyDownloadAttachmentValue:
        [[ExtSdkChatManagerWrapper getInstance] downloadAttachment:ps
                                                    withMethodType:methodType
                                                            result:callback];
        break;
    case ExtSdkMethodKeyDownloadThumbnailValue:
        [[ExtSdkChatManagerWrapper getInstance] downloadThumbnail:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    case ExtSdkMethodKeyImportMessagesValue:
        [[ExtSdkChatManagerWrapper getInstance] importMessages:ps
                                                withMethodType:methodType
                                                        result:callback];
        break;
    case ExtSdkMethodKeyLoadAllConversationsValue:
        [[ExtSdkChatManagerWrapper getInstance] loadAllConversations:ps
                                                      withMethodType:methodType
                                                              result:callback];
        break;
    ...
    case ExtSdkMethodKeyDeleteConversationValue:
        [[ExtSdkChatManagerWrapper getInstance] deleteConversation:ps
                                                    withMethodType:methodType
                                                            result:callback];
        break;
    ...
    case ExtSdkMethodKeyFetchHistoryMessagesValue:
        [[ExtSdkChatManagerWrapper getInstance] fetchHistoryMessages:ps
                                                      withMethodType:methodType
                                                              result:callback];
        break;
    case ExtSdkMethodKeySearchChatMsgFromDBValue:
        [[ExtSdkChatManagerWrapper getInstance] searchChatMsgFromDB:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    ...
    case ExtSdkMethodKeyAsyncFetchGroupAcksValue:
        [[ExtSdkChatManagerWrapper getInstance] fetchGroupReadAck:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    ...
    case ExtSdkMethodKeyGetMsgCountValue:
        [[ExtSdkConversationWrapper getInstance] getMsgCount:ps
                                              withMethodType:methodType
                                                      result:callback];
        break;
    ...
    case ExtSdkMethodKeyRemoveMsgValue:
        [[ExtSdkConversationWrapper getInstance] removeMsg:ps
                                            withMethodType:methodType
                                                    result:callback];
        break;
    ...
    case ExtSdkMethodKeyInsertMsgValue:
        [[ExtSdkConversationWrapper getInstance] insertMsg:ps
                                            withMethodType:methodType
                                                    result:callback];
        break;
    case ExtSdkMethodKeyAppendMsgValue:
        [[ExtSdkConversationWrapper getInstance] appendMsg:ps
                                            withMethodType:methodType
                                                    result:callback];
        break;
    ...
    case ExtSdkMethodKeyGetGroupsWithoutPushNotificationValue:
        [callback onFail:1
            withExtension:[NSString stringWithFormat:@"%@ is deprecated",
                                                     methodType]];
        break;
    ...
    case ExtSdkMethodKeyAddMembersValue:
        [[ExtSdkGroupManagerWrapper getInstance] addMembers:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    ...
    case ExtSdkMethodKeyLeaveGroupValue:
        [[ExtSdkGroupManagerWrapper getInstance] leaveGroup:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    ...
    case ExtSdkMethodKeyBlockGroupValue:
        [[ExtSdkGroupManagerWrapper getInstance] blockGroup:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    ...
    case ExtSdkMethodKeyAddAdminValue:
        [[ExtSdkGroupManagerWrapper getInstance] addAdmin:ps
                                           withMethodType:methodType
                                                   result:callback];
        break;
    ...
    case ExtSdkMethodKeyPublishPresenceWithDescriptionValue:
        [[ExtSdkPresenceManagerWrapper getInstance]
            publishPresenceWithDescription:ps
                            withMethodType:methodType
                                    result:callback];
        break;
    ...
    case ExtSdkMethodKeyChatAddReactionValue:
        [[ExtSdkChatManagerWrapper getInstance] addReaction:ps
                                             withMethodType:methodType
                                                     result:callback];
        break;
    case ExtSdkMethodKeyChatRemoveReactionValue:
        [[ExtSdkChatManagerWrapper getInstance] removeReaction:ps
                                                withMethodType:methodType
                                                        result:callback];
        break;
    case ExtSdkMethodKeyChatFetchReactionListValue:
        [[ExtSdkChatManagerWrapper getInstance] fetchReactionList:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    case ExtSdkMethodKeyChatFetchReactionDetailValue:
        [[ExtSdkChatManagerWrapper getInstance] fetchReactionDetail:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeyChatReportMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] reportMessage:ps
                                               withMethodType:methodType
                                                       result:callback];
        break;
    ...
    case ExtSdkMethodKeyChatGetReactionListValue:
        [[ExtSdkChatMessageWrapper getInstance] getReactionList:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    case ExtSdkMethodKeyChatGroupAckCountValue:
        [[ExtSdkChatMessageWrapper getInstance] getGroupAckCount:ps
                                                  withMethodType:methodType
                                                          result:callback];
        break;
    ...
    case ExtSdkMethodKeyChatJoinChatThreadValue:
        [[ExtSdkChatThreadManagerWrapper getInstance] joinChatThread:ps
                                                      withMethodType:methodType
                                                              result:callback];
        break;
    case ExtSdkMethodKeyChatLeaveChatThreadValue:
        [[ExtSdkChatThreadManagerWrapper getInstance] leaveChatThread:ps
                                                       withMethodType:methodType
                                                               result:callback];
        break;
    case ExtSdkMethodKeyChatDestroyChatThreadValue:
        [[ExtSdkChatThreadManagerWrapper getInstance]
            destroyChatThread:ps
               withMethodType:methodType
                       result:callback];
        break;
    case ExtSdkMethodKeyChatGetMessageThreadValue:
        [[ExtSdkChatThreadManagerWrapper getInstance] getChatThread:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;

    case ExtSdkReportPushActionValue:
        [[ExtSdkPushManagerWrapper getInstance] reportPushAction:ps
                                                  withMethodType:methodType
                                                          result:callback];
        break;
    case ExtSdkSetConversationSilentModeValue:
        [[ExtSdkPushManagerWrapper getInstance]
            setConversationSilentMode:ps
                       withMethodType:methodType
                               result:callback];
        break;
    case ExtSdkRemoveConversationSilentModeValue:
        [[ExtSdkPushManagerWrapper getInstance]
            removeConversationSilentMode:ps
                          withMethodType:methodType
                                  result:callback];
        break;
    case ExtSdkFetchConversationSilentModeValue:
        [[ExtSdkPushManagerWrapper getInstance]
            fetchConversationSilentMode:ps
                         withMethodType:methodType
                                 result:callback];
        break;
    case ExtSdkSetSilentModeForAllValue:
        [[ExtSdkPushManagerWrapper getInstance] setSilentModeForAll:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkFetchSilentModeForAllValue:
        [[ExtSdkPushManagerWrapper getInstance] fetchSilentModeForAll:ps
                                                       withMethodType:methodType
                                                               result:callback];
        break;
    case ExtSdkFetchSilentModeForConversationsValue:
        [[ExtSdkPushManagerWrapper getInstance]
            fetchSilentModeForConversations:ps
                             withMethodType:methodType
                                     result:callback];
        break;
    case ExtSdkSetPreferredNotificationLanguageValue:
        [[ExtSdkPushManagerWrapper getInstance]
            setPreferredNotificationLanguage:ps
                              withMethodType:methodType
                                      result:callback];
        break;
    case ExtSdkFetchPreferredNotificationLanguageValue:
        [[ExtSdkPushManagerWrapper getInstance]
            fetchPreferredNotificationLanguage:ps
                                withMethodType:methodType
                                        result:callback];
        break;
    ...
    case ExtSdkMethodKeyDeleteMessagesBeforeTimestampValue:
        [[ExtSdkChatManagerWrapper getInstance]
            deleteMessagesBeforeTimestamp:ps
                           withMethodType:methodType
                                   result:callback];
        break;
    ...
    case ExtSdkMethodKeyGetConversationsFromServerWithCursorValue:
        [[ExtSdkChatManagerWrapper getInstance]
            getConversationsFromServerWithCursor:ps
                                  withMethodType:methodType
                                          result:callback];
        break;
    case ExtSdkMethodKeyGetPinnedConversationsFromServerWithCursorValue:
        [[ExtSdkChatManagerWrapper getInstance]
            getPinnedConversationsFromServerWithCursor:ps
                                        withMethodType:methodType
                                                result:callback];
        break;
    case ExtSdkMethodKeyPinConversationValue:
        [[ExtSdkChatManagerWrapper getInstance] pinConversation:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    case ExtSdkMethodKeyModifyMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] modifyMessage:ps
                                               withMethodType:methodType
                                                       result:callback];
        break;
    case ExtSdkMethodKeyDownloadAndParseCombineMessageValue:
        [[ExtSdkChatManagerWrapper getInstance]
            downloadAndParseCombineMessage:ps
                            withMethodType:methodType
                                    result:callback];
        break;
    case ExtSdkSetPushTemplateValue:
        [[ExtSdkPushManagerWrapper getInstance] setPushTemplate:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    case ExtSdkGetPushTemplateValue:
        [[ExtSdkPushManagerWrapper getInstance] getPushTemplate:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    ...
    case ExtSdkMethodKeyfetchJoinedGroupCountValue:
        [[ExtSdkGroupManagerWrapper getInstance]
            fetchJoinedGroupCount:ps
                   withMethodType:methodType
                           result:callback];
        break;
    case ExtSdkMethodKeygetAllContactsValue:
        [[ExtSdkContactManagerWrapper getInstance] getAllContacts:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    case ExtSdkMethodKeysetContactRemarkValue:
        [[ExtSdkContactManagerWrapper getInstance] setContactRemark:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeygetContactValue:
        [[ExtSdkContactManagerWrapper getInstance] getContact:ps
                                               withMethodType:methodType
                                                       result:callback];
        break;
    case ExtSdkMethodKeyfetchAllContactsValue:
        [[ExtSdkContactManagerWrapper getInstance] fetchAllContacts:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeyfetchContactsValue:
        [[ExtSdkContactManagerWrapper getInstance] fetchContacts:ps
                                                  withMethodType:methodType
                                                          result:callback];
        break;

    case ExtSdkMethodKeygetPinInfoValue:
        [[ExtSdkChatMessageWrapper getInstance] getMessagePinInfo:ps
                                                   withMethodType:methodType
                                                           result:callback];
        break;
    case ExtSdkMethodKeypinnedMessagesValue:
        [[ExtSdkConversationWrapper getInstance] pinnedMessages:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    case ExtSdkMethodKeyaddRemoteAndLocalConversationsMarkValue:
        [[ExtSdkChatManagerWrapper getInstance]
            addRemoteAndLocalConversationsMark:ps
                                withMethodType:methodType
                                        result:callback];
        break;
    case ExtSdkMethodKeydeleteRemoteAndLocalConversationsMarkValue:
        [[ExtSdkChatManagerWrapper getInstance]
            deleteRemoteAndLocalConversationsMark:ps
                                   withMethodType:methodType
                                           result:callback];
        break;
    case ExtSdkMethodKeyfetchConversationsByOptionsValue:
        [[ExtSdkChatManagerWrapper getInstance]
            fetchConversationsByOptions:ps
                         withMethodType:methodType
                                 result:callback];
        break;
    case ExtSdkMethodKeydeleteAllMessageAndConversationValue:
        [[ExtSdkChatManagerWrapper getInstance]
            deleteAllMessageAndConversation:ps
                             withMethodType:methodType
                                     result:callback];
        break;
    case ExtSdkMethodKeypinMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] pinMessage:ps
                                            withMethodType:methodType
                                                    result:callback];
        break;
    case ExtSdkMethodKeyunpinMessageValue:
        [[ExtSdkChatManagerWrapper getInstance] unpinMessage:ps
                                              withMethodType:methodType
                                                      result:callback];
        break;
    case ExtSdkMethodKeyfetchPinnedMessagesValue:
        [[ExtSdkChatManagerWrapper getInstance] fetchPinnedMessages:ps
                                                     withMethodType:methodType
                                                             result:callback];
        break;
    case ExtSdkMethodKeysearchMessagesValue:
        [[ExtSdkChatManagerWrapper getInstance] searchMessages:ps
                                                withMethodType:methodType
                                                        result:callback];
        break;
    case ExtSdkMethodKeysearchMessagesInConversationValue:
        [[ExtSdkConversationWrapper getInstance] searchMessages:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
    case ExtSdkMethodKeyremoveMessagesWithTimestampValue:
        [[ExtSdkChatManagerWrapper getInstance]
            removeMessagesWithTimestamp:ps
                         withMethodType:methodType
                                 result:callback];
        break;
    case ExtSdkMethodKeygetMessageCountWithTimestampValue:
        [[ExtSdkConversationWrapper getInstance]
            getMessageCountWithTimestamp:ps
                          withMethodType:methodType
                                  result:callback];
        break;
    case ExtSdkMethodKeygetMessageCountValue:
        [[ExtSdkChatManagerWrapper getInstance] getMessageCount:ps
                                                 withMethodType:methodType
                                                         result:callback];
        break;
