...
class ExtSdkConversationHelper {
    ...
    static Map<String, Object> toJson(EMConversation conversation) {
        ...
        data.put("remindType", ExtSdkSilentModeParamHelper.pushRemindTypeToInt(conversation.pushRemindType()));
...
class ExtSdkRecalledMessageInfoHelper {
    static Map<String, Object> toJson(EMRecallMessageInfo info) {
        Map<String, Object> data = new HashMap<>();
        data.put("recalledMessageId", info.getRecallMessageId());
        data.put("recalledBy", info.getRecallBy());
        if (info.getExt() != null) {
            data.put("recalledExt", info.getExt());
        }
...
class ExtSdkEMMessageTypeHelper {
    static EMMessage.Type toType(String typeStr) {
...
class ExtSdkEMSearchDirectionHelper {
    static EMConversation.EMSearchDirection toDirection(String direction) {
