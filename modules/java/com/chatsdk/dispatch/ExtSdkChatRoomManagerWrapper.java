...
public class ExtSdkChatRoomManagerWrapper extends ExtSdkWrapper {
    ...
    public void joinChatRoom(JSONObject param, String channelName, ExtSdkCallback result) throws JSONException {
        ...
        boolean exitOtherRoom = param.optBoolean("exitOtherRoom", false);
        String ext = param.optString("ext");
        EMClient.getInstance().chatroomManager().joinChatRoom(
            roomId, exitOtherRoom, ext, new EMValueCallBack<EMChatRoom>() {
                @Override
                public void onSuccess(EMChatRoom emChatRoom) {
                    ExtSdkWrapper.onSuccess(result, channelName, ExtSdkChatRoomHelper.toJson(emChatRoom));
                }
