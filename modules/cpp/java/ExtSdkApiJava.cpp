...
void ExtSdkApiJava::initJni(JNIEnv* env) {
    ...
    jclass jcls = env->FindClass("com/chatsdk/dispatch/ExtSdkDispatch");
    if (jcls) {
    ...
    jmid_getInstance = env->GetStaticMethodID(jcls_ExtSdkDispatch, "getInstance",
                                                        "()Lcom/chatsdk/dispatch/ExtSdkDispatch;");
    jmid_callSdkApi = env->GetMethodID(jcls_ExtSdkDispatch, "callSdkApi",
                                                 "(Ljava/lang/String;Ljava/lang/Object;Lcom/chatsdk/common/ExtSdkCallback;)V");
    jmid_addListener = env->GetMethodID(jcls_ExtSdkDispatch, "addListener",
                                        "(Lcom/chatsdk/common/ExtSdkListener;)V");
...
Java_com_chatsdk_jni_ExtSdkApiJni_nativeInit(JNIEnv *env, jclass clazz,
                                                      jobject configures) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_chatsdk_jni_ExtSdkApiJni_nativeAddListener(JNIEnv *env, jclass clazz,
                                                             jobject listener) {
    EXT_SDK_NAMESPACE_USING
...
extern "C"
JNIEXPORT void JNICALL
Java_com_chatsdk_jni_ExtSdkApiJni_nativeDelListener(JNIEnv *env, jclass clazz,
                                                             jobject listener) {
    EXT_SDK_NAMESPACE_USING
    std::shared_ptr<ExtSdkObject> java_listener = std::make_shared<ExtSdkObjectJava>(listener);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_chatsdk_jni_ExtSdkApiJni_nativeCallSdkApi(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_chatsdk_jni_ExtSdkApiJni_nativeUnInit(JNIEnv *env, jclass clazz) {
    EXT_SDK_NAMESPACE_USING
    ExtSdkApi::getInstance()->unInit();
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_chatsdk_common_ExtSdkTypeUtil_nativeCurrentPlatform(JNIEnv *env, jclass clazz) {
    EXT_SDK_NAMESPACE_USING
    return (jint) ExtSdkConfig::current_platform_type;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_chatsdk_common_ExtSdkTypeUtil_nativeCurrentArchitecture(JNIEnv *env,
                                                                          jclass clazz) {
    EXT_SDK_NAMESPACE_USING
